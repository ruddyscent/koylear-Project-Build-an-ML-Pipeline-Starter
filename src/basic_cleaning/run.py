...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = 'Enter input artifact file path',
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = 'Enter output artifact file name',
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = 'Enter artifact description',
        required = True
    )
